...
const QuestionnaireManagement = () => {
    ...
    const rightToolbarTemplate = () => (
        <>
            ...
            <button label='Reload' onClick={loadData} className="btn btn-default" style={{ marginRight: '10px' }}><i className='fa fa-refresh' /> Reload</button>
    ...
    return (
        <div className="p-4">
            ...
            <AssignmentModal
                ...
                onAssignSuccess={handleAssignmentSuccess} // Add this prop
            />
