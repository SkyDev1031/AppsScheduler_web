    ...
    $.fn.tree_structure = function (options) {
        ...
        $("ul").each(function () {
            if ($(this).children('li').length == 1) {
                if ($(this).children('li').hasClass("right"))
                    $(this).prepend("<li class='temp-element' style='visibility: hidden'><div><span class='first_name'>14-TAPAS BERA</span></div></li>");
                else
                    $(this).append("<li class='temp-element' style='visibility: hidden'><div><span class='first_name'>14-TAPAS BERA</span></div></li>");
            }
        });
        ...
        return this.each(function () {
            ...
            if (fullwidth_option) {
                ...
                for (var j = 0; j <= loop; j++) {
                    fullwidth += parseInt(get_element.closest('ul').children('li').eq(j).width());
                }
